  ...
  <div>
        ...
        <el-row :gutter="20">
          <el-col :span="12" style="background-color: white">
            <div class="grid-content bg-purple">
              ...
              <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item>
                  <el-input v-model="listQuery.keyword" placeholder="Tìm kiếm" />
                </el-form-item>
                <el-form-item>
              ...
              <el-table :data="resdata.data" style="width: 100%">
                ...
                <el-table-column label="Thao tác">
                  <template slot-scope="scope">
                    <el-button type="primary" icon="el-icon-edit" circle @click="btnUpdate(scope.row)" />
                    <el-button type="danger" icon="el-icon-delete" circle @click="btnDelete(scope.row)" />
                    <el-button type="success" icon="el-icon-right" circle @click="btngetCategoryChild(scope.row)" />
                  </template>
                </el-table-column>
              </el-table>
            </div>
          ...
          <el-col :span="12" style="background-color: #fde4e4">
            <div class="grid-content bg-purple-light">
              <p class="_title0">
                Danh mục con {{ categoryname }}
              </p>
              <el-form :inline="true" :model="listQuery1" class="demo-form-inline">
                <el-form-item>
                  <el-input v-model="listQuery1.keyword" placeholder="Tìm kiếm" />
                </el-form-item>
                <el-form-item>
              ...
              <el-table :data="categorychild" style="width: 100%">
                ...
                <el-table-column label="Thao tác">
                  <template slot-scope="scope1">
                    <el-button type="primary" icon="el-icon-edit" circle @click="btnUpdateChild(scope1.row)" />
                    <el-button type="danger" icon="el-icon-delete" circle @click="btnDeleteChild(scope1.row)" />
                  </template>
                </el-table-column>
              </el-table>
            </div>
    ...
    <div>
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogcategory">
        <el-form ref="dataform2" :model="dataCategory" :rules="rules">
          <el-form-item label="Tên" prop="name" :label-width="formLabelWidth">
            <el-input v-model="dataCategory.name" autocomplete="off" />
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
          <el-button @click="dialogcategory = false">hủy</el-button>
          <el-button type="primary" @click="dialogStatus === 'create' ? handleCreate() : handleUpdate()">Xác nhận
          </el-button>
        </span>
      </el-dialog>
      <el-dialog :title="textMap1[dialogStatus1]" :visible.sync="dialogcategorychild">
        <el-form ref="dataform3" :model="dataCategorychild" :rules="rules1">
          <el-form-item v-if="dialogStatus1 === 'create'" label="Chon danh muc" :label-width="formLabelWidth">
            <el-select v-model="dataCategorychild.category_id" placeholder="Chọn" prop="category_id" filterable remote
              reserve-keyword>
              <el-option v-for="item in listcCategory" :key="item.id" :label="item.name" :value="item.id" />
            </el-select>
          </el-form-item>
          <el-form-item label="Tên" prop="name" :label-width="formLabelWidth">
            <el-input v-model="dataCategorychild.name" autocomplete="off" />
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
